        ...
        <div className="command-palette-overlay" onClick={() => setModal(null)}>
          <div className="glass-card animate-fade-in m-3" style={{ maxWidth: '500px', width: '100%', maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><Field label="Subject *" id="t_subj" value={form.subject} onChange={e => set('subject', e.target.value)} error={formErrors.subject} placeholder="e.g. Mathematics" /></div>
              <div className="col-md-6"><Field label="Assigned Class" id="t_std" value={form.assigned_standard} onChange={e => set('assigned_standard', e.target.value)} placeholder="e.g. Class 10" /></div>
